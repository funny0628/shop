  ...
  <view>
    ...
    <navigator url="/pages/address/address?source=1" class="address-section">
      <view class="order-content">
        ...
        <view class="cen">
          ...
          <text class="address"
            >{{ addressData.address }} {{ addressData.area }}</text
          >
        </view>
    ...
    <view class="goods-section">
      <view class="g-header b-b">
        <image
          class="logo"
          src="http://duoduo.qibukj.cn/./Upload/Images/20190321/201903211727515.png"
        ></image>
        <text class="name">西城小店铺1</text>
      </view>
      <!-- 商品列表 -->
      <view class="g-item">
        <image
      ...
      <view class="g-item">
        ...
        <view class="right">
          <text class="title clamp"
            >韩版于是洞洞拖鞋 夏季浴室防滑简约居家【新人专享，限选意见】</text
          >
          <text class="spec">春装款 L</text>
          <view class="price-box">
            <text class="price">￥17.8</text>
    ...
    <view class="footer">
      ...
      <text class="submit" @tap="submit">提交订单</text>
    </view>
...
<script>
// import { addShopCart } from "@/utils/fetch";
